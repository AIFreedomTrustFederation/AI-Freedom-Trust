...
\hypersetup{
  pdftitle={AetherCore Test Series 001--006: Trust Density, Trust Migration, and COVID Shock Recovery},
  pdfsubject={An empirical white paper testing trust-density and trust-migration hypotheses using WVS, OWID, YouGov, and World Bank WGI data}
}
